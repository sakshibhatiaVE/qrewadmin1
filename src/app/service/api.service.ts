...
export class ApiService {
  ...
  baseUri: string = 'http://18.234.205.227:4000/api';
  baseUri1: string = 'http://18.234.205.227:4000/api/getroles';
  baseUri2: string = 'http://18.234.205.227:4000/api/announcements';
  baseUri3: string = 'http://18.234.205.227:4000/users';
  ...
  updateUser(id, data): Observable<any> {
    let url = `${this.baseUri3}/update/${id}`;
    return this.http
      .put(url, data, { headers: this.headers })
      .pipe(catchError(this.errorMgmt));
  }
